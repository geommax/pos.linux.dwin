...
# interprocess communication အတွက်ဖြစ်ပါတယ်။
#dbus-send --session --print-reply --dest=com.example.UsbSignal /com/example/UsbSignal com.example.UsbSignal.USBReady
